<div class="row">
<h3 class="text-center">Adjuntar Archivos Orden de Compra Nivel Central</h3>
<hr>
<div class="col-lg-offset-3 col-xs-6 col-sm-6 col-md-6 col-lg-6">
<div class="well">
<?=form_open_multipart('perfil/do_upload_oc_nc/'.$codigomemo); ?>
...
<div class="form-group">
<?php
echo form_label('Archivos Requeridos', 'file2');
?>
<input type="file" name="file2" class="form-control" value="" required="required">
