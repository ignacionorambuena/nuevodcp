...
<div class="row">
<h3 class="text-center">Panel Notificaciones Revisados</h3>
<hr>
...
<tbody>
<?php 	foreach($revisados as $gas){ ?>
<tr>

<!-- <td align="center"><a href="<?php echo base_url('perfil/subir_mdos_firma/'.$gas->codGasto); ?> "><b><i class="fa fa-upload fa-2x"></i></b></a></td>
<td><a href="<?php echo base_url('perfil/memo_etapa_dos/'.$gas->codGasto); ?> ">Generar Memo</a></td> -->
<td align="center">
<?php
if($gas->adj_memo_dos==""){
?>
