...
JEFE DEPTO. DE ADMINSITRACIÓN Y FINANZAS<br>
...
<?php
if ($memo->tipogasto==1) {
echo "SOLICITUD DE O.C";
}
else if ($memo->tipogasto==2) {
echo "SOLICITUD DE PAGO BOLETA HONORARIO";
}
...
echo "SOLICITUD DE PAGO LICITACIÓN";
}
...
<b><?php echo strtoupper(str_replace($busca,$remplaza,$memo->jefedepto)); ?><br>
<?php if($memo->jefedepto=="Soledad Castillo M"){ ?>
COORDINADORA DE PROGRAMA<br>
<?php
}
else {
...
<hr>
<center>
<a href="<?php echo base_url('perfil/generate_dos/'.$memo->codGasto); ?>" class="btn btn-danger btn-block btn-md">Generar Memorándum</a>
</center>
<?php } ?>
</div>
