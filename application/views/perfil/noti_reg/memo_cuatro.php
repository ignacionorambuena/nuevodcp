...
JEFE DEPTO. (S) COORDINACIÓN PROGRMÁTICA<br>
...
<td width="1%" valign="top">:</td>
<td width="90%" valign="top">
<?php echo strtoupper($memo->directorreg); ?><br>
...
<?php
if ($memo->tipogasto==1) {
echo "SOLICITA PAGO DE LA FACTURA";
}
...
Junto con enviar mis cordiales saludos y en el marco del <?php echo $memo->nombreProg; ?>, <?php echo $memo->nombreComp; ?>, solicito gestión el pago de la factura de acuerdo al siguiente detalle:
</td>
</tr>
<tr>
<td colspan="3">&nbsp;</td>
...
<td width="88%">CUENTA RUT</td>
</tr>
<tr>
<td width="12%">Nombre Banco :</td>
<td width="88%">BANCO ESTADO</td>
</tr>
<tr>
...
<b><?php echo strtoupper(str_replace($busca,$remplaza,$memo->directorreg)); ?><br>
DIRECTOR REGIONAL<br>
<?php echo strtoupper($memo->nombreReg);?> <br>
...
<hr>
<center>
<a href="<?php echo base_url('perfil/generate_cuatro/'.$memo->codGasto); ?>" class="btn btn-danger btn-md btn-block">Generar Memorándum</a>
</center>
<?php } ?>
</div>
