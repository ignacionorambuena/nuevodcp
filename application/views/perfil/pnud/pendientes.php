...
<div class="row">
<h3 class="text-center">Panel PNUD Pendientes</h3>
<hr>
...
<tr>
<!-- <td><a href="<?php echo base_url('perfil/revisar_etapa_tres/'.$gas->codGasto); ?> ">Revisar</a></td> -->
<td align="center">
<?php
if ($gas->tipogasto==1) {
if($gas->numerooc!=""){
?>
<a href="<?php echo base_url('perfil/adjuntar_memo_tres/'.$gas->codGasto); ?>"><i class="fa fa-upload fa-2x"></i> </a>
...
if($gas->numerooc!=""){
?>
<a href="<?php echo base_url('perfil/adjuntar_memo_tres_oc_nc/'.$gas->codGasto); ?>"><i class="fa fa-upload fa-2x"></i> </a>
...
if ($gas->numerooc=="") {
?>
<a href="<?php echo base_url('perfil/revisar_etapa_tres/'.$gas->codGasto); ?>">Revisar</a>
<?php
}
else{
?>
<a href="<?php echo base_url('perfil/memo_etapa_tres/'.$gas->codGasto); ?> ">Generar OC</a>
<?php
}?>
</td>
...
<!-- <td><a class="btn btn-danger btn-sm" target="_blank" href="<?php echo base_url('/uploads/'.$gas->codGasto.'.pdf'); ?>"><b><i class="fa fa-file-pdf-o"></i></b></a></td> -->
<td>
