<div class="row">
<h3 class="text-center">Adjuntar Memorandum 3ª Etapa (PNUD)</h3>
<hr>
<div class="col-lg-offset-3 col-xs-6 col-sm-6 col-md-6 col-lg-6">
<div class="well">
<?=form_open_multipart('perfil/do_upload_tres_oc_nc/'.$codigomemo); ?>
<div class="form-group">
<?php
echo form_label('Orden de Compra', 'file1');
?>
