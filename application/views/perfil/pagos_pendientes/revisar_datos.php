...
<?php foreach ($pendiente_etapa_seis as $rev){ ?>

<div class="row">
<h3 class="text-center">Revisión Pago Facturas 6ª Etapa</h3>
<hr>
...
<input type="text" name="numerofactura" id="input" class="form-control input-sm" value="<?php echo $rev->numerofactura; ?>" disabled>
</div>
...
<input type="hidden" name="aceptar" value="a">
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<button type="submit" class="btn btn-success btn-block">Devengar <i class="fa fa-check"></i></button>
		</form>
		</div>
	</div>
</div>
