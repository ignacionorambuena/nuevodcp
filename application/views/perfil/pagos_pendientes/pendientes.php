...
<div class="row">
<h3 class="text-center">Panel Pago Facturas pendientes 6ª Etapa</h3>
<hr>
...
<tbody>
<?php 	foreach($pago_pendientes as $gas){ ?>
<tr>
<td><a href="<?php echo base_url('perfil/revisar_etapa_seis/'.$gas->codGasto); ?> ">Revisar</a></td>
