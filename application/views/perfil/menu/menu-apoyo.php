...
<ul class="dropdown-menu">
<li><a href="<?php echo base_url('/perfil/notificaciones'); ?>">Ver Pendientes</a></li>
<li><a href="<?php echo base_url('/perfil/revisados'); ?>">Ver Revisados</a></li>
...
<li class="dropdown">
<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-book"></i> <!-- <span class="badge"><?php echo $cant_noti; ?></span> -->  <b class="caret"></b></a>
<ul class="dropdown-menu">
<li><a href="<?php echo base_url('/perfil/solicitud_pago_facturas'); ?>">Pago Facturas Pendiente</a></li>
<li><a href="<?php echo base_url('/perfil/pago_facturas_revisada'); ?>">Pago Facturas Revisada</a></li>
<!-- <li><a href="<?php echo base_url('/perfil/all_noti'); ?>">Ver Todos</a></li> -->
</ul>
</li>
...
<li><a href="<?php echo base_url('/perfil/saldo_proveedor'); ?>">Saldo Proveedor</a></li>
</ul>
</li>
