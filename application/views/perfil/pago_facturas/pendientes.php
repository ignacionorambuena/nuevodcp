...
<div class="row">
<h3 class="text-center">Panel Pendientes Pago Facturas 5ª Etapa</h3>
<hr>
...
<tbody>
<?php 	foreach($pago_facturas as $gas){ ?>
<tr>
<!-- <td><a href="<?php echo base_url('perfil/revisar_etapa_cinco/'.$gas->codGasto); ?> ">Revisar</a></td> -->
<td align="center">
<?php
if($gas->adj_memo_cinco=="Falta"){
?>
<a href="<?php echo base_url('perfil/adjuntar_memo_cinco/'.$gas->codGasto); ?>"><i class="fa fa-upload fa-2x"></i> </a>
...
if ($gas->adj_memo_cinco!="Falta") {
?>
<a href="<?php echo base_url('perfil/revisar_etapa_cinco/'.$gas->codGasto); ?>">Revisar</a>
<?php
}
else{
?>
<a href="<?php echo base_url('perfil/memo_etapa_cinco/'.$gas->codGasto); ?> ">Generar Memo</a>
<?php
}?>
</td>
