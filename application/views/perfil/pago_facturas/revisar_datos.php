...
<?php foreach ($ver_pago as $rev){ ?>

<div class="row">
<h3 class="text-center">Revisión Pago Facturas 5ª Etapa</h3>
<hr>
...
<input type="text" name="numerooc" class="form-control input-sm" value="<?php echo $rev->numerooc; ?>" disabled>
</div>
...
<?php
if($rev->tipogasto==1){
  $nombreTipoGasto="Orden de Compra";
}
else if($rev->tipogasto==2){
  $nombreTipoGasto="Boleta Honorarios";
}
else if($rev->tipogasto==3){
  $nombreTipoGasto="Pago Directo";
}
else if($rev->tipogasto==4){
  $nombreTipoGasto="Licitación";
}
else if($rev->tipogasto==5){
  $nombreTipoGasto="Orden de Compra Nivel Central";
}
?>

<option><?php echo $nombreTipoGasto; ?></option>
...
<input type="hidden" name="aceptar" value="a">
    ...
    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
      <a href="#" class="btn btn-block btn-danger"> Rechazar <i class="fa fa-ban"></i></a>
    </div>
	</div>
</div>
</div>
