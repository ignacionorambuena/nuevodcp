...
<td width="1%" valign="top">:</td>
<td width="90%" valign="top">
'.strtoupper(str_replace($busca,$remplaza,$memo->jefedepto)).'<br>';


if($memo->jefedepto=="Soledad Castillo M"){
$nombreSol="COORDINADORA DE PROGRAMA<br>";
}
else{
$nombreSol="JEFE /A (S) DEPTO. DE COORDINACIÓN PROGRAMÁTICA<br>";
}


$codigoHTML.=''.$nombreSol.'
INSTITUTO NACIONAL DE LA JUVENTUD
</td>
</tr>
...
<b>'.strtoupper($memo->jefedepto).'<br>';
...
if($memo->directorreg=="Soledad Castillo M"){
