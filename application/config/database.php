...
$db['default']['password'] = '2wsxcde3';
//$db['default']['password'] = '';
$db['default']['database'] = 'aaa_controlpresupuestario';
...
/*Configuracion db intranet*/

$db['prueba']['hostname'] = 'localhost';
$db['prueba']['username'] = 'root';
$db['prueba']['password'] = '2wsxcde3';
//$db['default']['password'] = '';
$db['prueba']['database'] = 'intranet';
